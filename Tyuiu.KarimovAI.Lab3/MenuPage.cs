...
namespace Tyuiu.KarimovAI.Lab3.Review.V13
{
    public class MenuPage : IPage
    {
        ...
        private void RenderHead()
        {
            ...
            //4 row
            Console.Write("║");
            for (int i = 0; i < (120 - 2 - "Выполнил Каримов Алик Ильгизович".Length) / 2; i++)
            {
                Console.Write(" ");
            }
            Console.Write("Выполнил Каримов Алик Ильгизович");
            for (int i = 0; i < (120 - 2 - "Выполнил Каримов Алик Ильгизович".Length) / 2 + (120 - 2 - "Выполнил Каримов Алик Ильгизович".Length) % 2; i++)
            {
                Console.Write(" ");
            }
            Console.Write("║");
